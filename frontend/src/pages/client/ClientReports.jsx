      ...
      {!isPro ? (
        <div className="mt-6">
          <PlanGate
            ...
            title="Informes PDF de seguridad"
            description="Genera y descarga informes mensuales completos con análisis de amenazas, top IPs atacantes y estado de sensores. Disponible en el plan Profesional (€30/mes)."
          />
        </div>
      ) : (
        <motion.div
          ...
          <div className="flex items-start justify-between mb-8 pb-6 border-b" style={{ borderColor: 'var(--border)' }}>
            ...
            <div className="text-right">
              ...
              <p className="text-xs mt-1" style={{ color: 'var(--txt-3)' }}>
                Plan: <span className="font-bold capitalize">{plan}</span>
              </p>
            </div>
          </div>
