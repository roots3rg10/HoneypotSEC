    ...
    <div className="min-h-screen" style={{ background: 'var(--bg)', color: 'var(--txt)' }}>
      ...
      <section className="max-w-6xl mx-auto px-6 pt-32 pb-14 text-center">
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45 }}>
          ...
          <p className="text-lg max-w-xl mx-auto mb-10" style={{ color: 'var(--txt-2)' }}>
          ...
          <div className="inline-flex items-center gap-6 rounded-xl px-6 py-3"
            ...
            <div className="text-center">
              <p className="font-display font-black text-xl" style={{ color: 'var(--txt)' }}>{hpStats.length}</p>
        ...
        <div className="rounded-2xl overflow-hidden"
          ...
          <div className="flex items-center justify-between p-6" style={{ borderBottom: '1px solid var(--border)' }}>
            <div className="flex items-center gap-3">
              ...
              <h2 className="font-display font-bold text-base" style={{ color: 'var(--txt)' }}>Actividad en tiempo real</h2>
            </div>
          ...
          {feed.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16" style={{ opacity: 0.3 }}>
              ...
              <p className="text-xs font-bold uppercase tracking-widest" style={{ color: 'var(--txt)' }}>Cargando...</p>
            </div>
          ) : (
