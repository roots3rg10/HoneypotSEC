    ...
    <aside className="w-68 flex flex-col shrink-0 z-50"
      ...
      <div className="px-7 py-7 border-b" style={{ borderColor: 'rgba(255,255,255,0.05)' }}>
        ...
        >
          ...
          <div>
            <h2 className="font-display font-black text-base leading-none tracking-tight text-white">HONEYPOT</h2>
            <p className="text-[10px] font-bold tracking-[0.2em] mt-0.5" style={{ color: '#FBBF24' }}>CYBERSECURITY</p>
          </div>
        </motion.div>
      </div>
      ...
      <div className="p-4 border-t" style={{ borderColor: 'rgba(255,255,255,0.05)' }}>
        <div className="px-3 py-3 rounded-xl" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)' }}>
          <div className="flex items-center gap-2.5 mb-2.5">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-[11px] font-bold text-white uppercase tracking-wider truncate">{user?.username}</p>
              <p className="text-[10px] text-white/30 capitalize">{user?.role}</p>
            </div>
          </div>
          <button
            onClick={handleLogout}
            className="w-full flex items-center gap-2 px-2 py-1.5 rounded-lg text-[11px] text-white/30 hover:text-white/60 hover:bg-white/5 transition-all"
          >
